...
function renderPresetButton(preset) {
  ...
  return `<button class="preset-button" type="button" data-preset="${escapeAttribute(preset.id)}"><span class="preset-title">${escapeHtml(label)}</span> <span class="preset-summary"><span class="preset-context">${escapeHtml(summaryContext)}</span><span class="preset-equity">${escapeHtml(equityBand)}</span></span></button>`;
}
